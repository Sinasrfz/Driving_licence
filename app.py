    ...
    with col_table:
        ...
        if len(df_filtered) > 0:
            selected_word = st.selectbox(
                ...
                options=df_filtered["word"].tolist(),
                index=0,
            )
        else:
            selected_word = None
    ...
    with col_detail:
        ...
        if selected_word is not None:
            ...
            if row["examples"].strip():
                # Split examples by our separator (if any)
    ...
    with col_left:
        ...
        if st.session_state.quiz_current is None:
            ...
            if row["examples"].strip():
                ...
                st.info("No example sentences available for this word.")
